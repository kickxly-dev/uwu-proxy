...
const GAMES = [
  ...
  { name: "Skribbl.io",         url: "https://skribbl.io/",                                           tag: "io",      category: "io",      desc: "Draw and guess with friends",          direct: true  },
  { name: "Smash Karts",        url: "https://smashkarts.io/",                                        tag: "io",      category: "io",      desc: "Kart battle royale",                   direct: true  },
  { name: "Doomz.io",           url: "https://doomz.io/",                                             tag: "io",      category: "io",      desc: "Multiplayer doom-style shooter",       direct: true  },
  { name: "JustFall.lol",       url: "https://justfall.lol/",                                         tag: "io",      category: "io",      desc: "Fall and survive",                     direct: true  },
  { name: "LOLBeans",           url: "https://lolbeans.io/",                                          tag: "io",      category: "io",      desc: "Bean battle royale",                   direct: true  },
  // Classic
  ...
  { name: "Minecraft Classic",  url: "https://classic.minecraft.net/",                                tag: "classic", category: "classic", desc: "Classic Minecraft in browser",         direct: true  },
  ...
  { name: "Little Alchemy 2",   url: "https://littlealchemy2.com/",                                   tag: "puzzle",  category: "puzzle",  desc: "Combine elements to make new things",  direct: true  },
  { name: "Connect Four",       url: "https://papergames.io/en/connect4",                             tag: "puzzle",  category: "puzzle",  desc: "Classic connect four",                 direct: true  },
  // Casual
  ...
  { name: "Cookie Clicker",     url: "https://orteil.dashnet.org/cookieclicker/",                     tag: "casual",  category: "casual",  desc: "Click cookies, build an empire",       direct: true  },
  { name: "Gartic Phone",       url: "https://garticphone.com/",                                      tag: "casual",  category: "casual",  desc: "Telephone with drawings",              direct: true  },
  { name: "Monkeytype",         url: "https://monkeytype.com/",                                       tag: "casual",  category: "casual",  desc: "Clean typing speed test",              direct: true  },
  { name: "GeoGuessr",          url: "https://www.geoguessr.com/",                                    tag: "casual",  category: "casual",  desc: "Guess where you are in the world",     direct: true  },
];
